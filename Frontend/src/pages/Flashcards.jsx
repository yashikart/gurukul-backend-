...
const Flashcards = () => {
    ...
    const handleAnswer = async (isCorrect) => {
        ...
        try {
            ...
            // Award karma
            if (isCorrect) {
                addKarma(10, 'Correct answer! 🎯');
            } else {
                addKarma(5, 'Keep practicing! 📚');
            }

            // Show success message
            if (result.message) {
                success(result.message, 'Review Submitted');
            }
                                    ...
                                    {isFlipped && (
                                        <div className="flex gap-4">
                                            <button
                                                ...
                                                disabled={submitting}
                                                className="px-8 py-4 bg-red-600/20 hover:bg-red-600/30 text-red-400 rounded-xl border-2 border-red-500/50 transition-all font-medium flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                                            >
                                            ...
                                            <button
                                                ...
                                                disabled={submitting}
                                                className="px-8 py-4 bg-green-600/20 hover:bg-green-600/30 text-green-400 rounded-xl border-2 border-green-500/50 transition-all font-medium flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                                            >
