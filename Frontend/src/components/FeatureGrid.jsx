                ...
                {features.map((feature, index) => (
                    ...
                    >
                        ...
                        <div className="relative z-10 flex flex-col items-center justify-center gap-3 sm:gap-4 text-white">
                            <div className="p-3 sm:p-4 rounded-full bg-white/10 border border-white/10 group-hover:scale-110 transition-transform duration-500 group-hover:border-accent/50 group-hover:bg-accent/20">
