  ...
  const fetchAllContent = async () => {
    try {
      ...
      const [summariesData, flashcardsData, testResultsData, subjectDataData] = await Promise.all([
        parentAPI.getChildSummaries(studentId),
        parentAPI.getChildFlashcards(studentId),
        parentAPI.getChildTestResults(studentId),
        parentAPI.getChildSubjectData(studentId)
      ]);
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h1 className="text-3xl font-bold text-gray-900">Child's Generated Content</h1>
        <button
          onClick={fetchAllContent}
      ...
      <div className="space-y-6">
        ...
        {totalItems === 0 && (
          <div className="bg-white rounded-lg shadow-md p-12 text-center">
            ...
            <p className="text-gray-600">Your child hasn't generated any content in Gurukul yet.</p>
          </div>
        )}
      </div>
    </div>
