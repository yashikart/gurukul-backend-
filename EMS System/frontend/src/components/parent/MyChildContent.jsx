  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h1 className="text-3xl font-bold text-white">Child's Generated Content</h1>
        <button
          onClick={fetchAllContent}
      ...
      <div className="space-y-6">
        ...
        {totalItems === 0 && (
          <div className="card-dark p-12 text-center">
            ...
            <p className="text-gray-400">Your child hasn't generated any content in Gurukul yet.</p>
          </div>
        )}
      </div>
    </div>
